...
#include <l3xz_ros_cyphal_bridge/phy/opencyphal/types/uavcan/node/Heartbeat_1_0.h>
...
public:
  ...
  static Heartbeat_1_0 deserialize(CanardRxTransfer const & transfer)
  {
    Heartbeat_1_0 h;
  ...
  {
    data.health.value = static_cast<uint8_t>(health);
  }

  void operator = (Mode const mode)
  {
    data.mode.value = static_cast<uint8_t>(mode);
  }
};
